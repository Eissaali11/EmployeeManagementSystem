#!/usr/bin/env python3
"""
إصلاح مشكلة التقارير في حزمة النشر
"""

import os
import shutil

def fix_employee_basic_report():
    """إصلاح ملف تقرير الموظف الأساسي"""
...
'''
    ...
    # حفظ الملف المُصحح
    with open('utils/employee_basic_report_fixed.py', 'w', encoding='utf-8') as f:
        f.write(content)
    
    print("تم إنشاء ملف التقرير المُصحح")

if __name__ == "__main__":
    fix_employee_basic_report()