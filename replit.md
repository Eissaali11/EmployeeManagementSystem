...
## Changelog
- July 8, 2025: **إصلاح شامل لمشكلة المحتوى المختفي خلف القائمة السفلية:**
  • أضافة padding-bottom: 120px لجميع صفحات الموبايل
  • إصلاح مشكلة المحتوى المقطوع في صفحة تفاصيل السيارة
  • تطبيق نفس الحل على صفحات التفويضات الخارجية (عرض، تعديل، إنشاء)
  • ضمان رؤية كامل المحتوى دون انقطاع من القائمة السفلية
