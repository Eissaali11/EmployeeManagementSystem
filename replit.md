...
## Changelog
- July 8, 2025: **إضافة زر المشاركة للتفويضات الخارجية:**
  • إضافة زر مشاركة أخضر جديد لكل تفويض خارجي في الجدولين (المختصر والموسع)
  • دالة JavaScript للمشاركة تدعم Web Share API مع نسخ احتياطي للحافظة
  • رسائل مشاركة منظمة تتضمن: اسم الموظف، نوع التفويض، التاريخ، المشروع، المدينة
  • تصميم مستجيب مع أيقونة share-alt ونافذة احتياطية للعرض
