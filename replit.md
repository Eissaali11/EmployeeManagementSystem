...
## Changelog
- July 14, 2025: **توحيد خط beIN Normal عبر جميع أنظمة PDF:**
  • تحديث نظام تسليم واستلام المركبات ليستخدم نفس خط beIN Normal المحسن
  • إنشاء utils/professional_arabic_handover_pdf.py مع نفس النظام المستخدم في الرواتب
  • توحيد معالجة النصوص العربية مع arabic_reshaper و bidi عبر جميع تقارير PDF
  • استبدال نظام WeasyPrint القديم بنظام FPDF المحسن والسريع
  • جميع PDFs تستخدم الآن نفس الخط والتصميم المتناسق: رواتب، تسليم واستلام
  • حل مشاكل المعاملات في دالة safe_cell وإضافة معامل fill
  • النظام يعرض اسم الخط المُستخدم في كل PDF للتحقق من التوحيد
