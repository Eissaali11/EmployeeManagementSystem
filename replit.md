...
## Recent Updates
- July 22, 2025: **تحديث شامل لرسائل WhatsApp للسائقين لتكون أكثر اختصاراً وتتضمن معلومات نجم:**
  • تحديث جميع رسائل WhatsApp في ملفات JavaScript (whatsapp.js, whatsapp-direct.js)
  • تقصير محتوى الرسائل لتكون أكثر وضوحاً وسهولة قراءة
  • إضافة رابط واتساب نجم للطوارئ: https://wa.me/966920000560
  • إضافة الرقم الموحد لنجم: 199033
  • تحديث أرقام الطوارئ المختصرة: 🚑 997 | 🚓 993 | 🛣️ 996 | 🚔 999 | 🔥 998
  • تبسيط ملاحظات صيانة السيارة لنقاط مختصرة ومباشرة
  • تحديث utils/whatsapp_helper.py لاستخدام التنسيق الجديد المختصر
  • اختبار النظام بنجاح: تم إرسال طلب فحص سلامة رقم 20 للمركبة 23 بنجاح
  • النظام يعمل بشكل مثالي مع الرسائل الجديدة المحسنة والمختصرة

## Changelog
- July 22, 2025: **حل نهائي لعرض الوثائق في صفحة تفاصيل الموظف:**
  • تأكيد أن النظام يعمل بالشكل الصحيح - يعرض جميع أنواع الوثائق الـ8
  • الوثائق الموجودة تظهر بالبيانات الكاملة (رقم الوثيقة، التواريخ، الحالة)
  • الوثائق غير الموجودة تظهر برسالة "لا توجد وثيقة" مع زر إضافة
  • إضافة رسالة توضيحية للمستخدم لشرح آلية عمل النظام
  • إضافة رقم إصدار v2.1 لضمان عدم استخدام المتصفح للكاش
  • تأكيد من قاعدة البيانات: الموظف HUSSAM AL DAIN لديه وثيقة الهوية الوطنية فقط
  • النظام يحافظ على عرض شامل لجميع أنواع الوثائق لسهولة الإدارة

## Changelog
- July 21, 2025: **إصلاح روابط الواتساب لتوجه مباشرة للمحادثة بدلاً من api.whatsapp.com:**
  • حل مشكلة الروابط التي كانت تُحول إلى api.whatsapp.com بدلاً من فتح المحادثة مباشرة
  • إنشاء utils/whatsapp_helper.py مع دوال مساعدة لإنشاء روابط wa.me مبسطة
  • تبسيط رسائل الواتساب لتكون قصيرة ومباشرة مع الأيقونات الأساسية
  • تحديث جميع templates (view_clean.html، view.html، mobile/vehicle_details.html)
  • استخدام ترميز URL مبسط (%20 للمساحات، %0A للأسطر الجديدة)
  • رسائل محسنة تحتوي على: الترحيب 👋، معلومات المركبة 🚗، التاريخ 📅، رابط PDF 📋، الشكر 🙏
  • إزالة الترميز المعقد والنصوص الطويلة التي كانت تسبب مشاكل في التوجيه
  • الروابط الآن تفتح المحادثة مباشرة في تطبيق الواتساب بدون إعادة توجيه
...
- July 20, 2025: **تحسين شامل لنظام قيود العمليات للمركبات خارج الخدمة مع رسائل خطأ محسنة:**
  • تحسين رسالة الخطأ في دالة check_vehicle_operation_restrictions لتكون أكثر وضوحاً ومفيدة
  • إضافة رقم اللوحة وأيقونة تحذير في رسالة القيود للمساعدة في التعرف على السيارة
  • تطبيق فحص قيود العمليات على دوال التشك لست في النسخة المحمولة (add_vehicle_checklist)
  • إضافة فحص القيود لدالة عرض تفاصيل التشك لست مع تمرير تحذير للواجهة
  • تحسين دوال تصدير PDF للتشك لست في routes/reports.py مع تحذيرات للسيارات خارج الخدمة
  • إضافة تحذير بصري في template تفاصيل التشك لست للإشارة لحالة السيارة خارج الخدمة
  • تطبيق نفس المنطق على دالة تصدير PDF في النسخة المحمولة (mobile_vehicle_checklist_pdf)
  • النظام الآن يحمي بشكل شامل جميع عمليات التشك لست ويعرض تحذيرات واضحة للمستخدمين
- July 22, 2025: **إصلاح شامل لنظام واتساب لتجنب إعادة التوجيه إلى api.whatsapp.com:**
  • تطوير دالة JavaScript محسنة redirectToWhatsApp تستخدم window.location.href
  • إصلاح مشكلة التوقف في صفحة api.whatsapp.com قبل فتح تطبيق واتساب
  • استعادة الرسالة الاحترافية الكاملة مع أرقام الطوارئ والإرشادات الأمنية
  • إضافة رابط صورة الاستمارة للرسالة عند توفرها
  • تحديث جميع templates لاستخدام الدالة الجديدة المحسنة
  • إنشاء ملف whatsapp-direct.js مخصص للتحكم المباشر في روابط واتساب
  • الرسالة تتضمن: تحية احترافية، روابط الوثائق، أرقام الطوارئ، إرشادات السلامة
  • النظام الآن يفتح المحادثة مباشرة في تطبيق واتساب بدون توقف وسطي
- July 22, 2025: **إصلاح نهائي لنظام إنشاء PDF التسليم/الاستلام - وضع رقم العمل في حقل رقم الشركة:**
  • تم نقل رقم العمل من قسم "معلومات العمل" إلى حقل "رقم الشركة" كما طلب المستخدم
  • تغيير عنوان القسم من "معلومات العمل" إلى "معلومات الشركة" 
  • الآن يظهر رقم العمل (مثل W000056) في الحقل الصحيح "رقم الشركة" في PDF
  • الاحتفاظ بحالة المركبة وتاريخ العملية في نفس القسم مع رقم الشركة
  • إصلاح شامل لتحديث Fabric.js إلى إصدار 5.3.0 مع نظام تحميل ذكي
  • إضافة نظام CDN fallback محسن ومعالجة أخطاء شاملة لخريطة الضرر
  • تحسين console logging لتشخيص مشاكل Fabric.js وتحسين أداء النظام
  • النظام الآن يعرض خرائط الضرر بنجاح ويولد PDF بالتنسيق المطلوب
- July 16, 2025: **تحديث نظام توليد PDF لفحوصات السلامة لاستخدام خط beIN-Normal العربي:**
  • إصلاح نظام اختيار الخط العربي في مولد PDF لفحوصات السلامة الخارجية
  • تحديث كود export_safety_check_pdf لاستخدام خط beIN-Normal.ttf بشكل أولوي
  • إضافة نظام fallback محسن للخطوط مع ترتيب أولوية: beIN-Normal → beIN Normal → Cairo → NotoSansArabic
