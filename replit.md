...
## Changelog
- July 7, 2025: **إضافة نظام مشاركة سجلات التسليم والاستلام:**
  • إضافة زر مشاركة جديد في جدول سجلات التسليم والاستلام
  • رسائل مشاركة شاملة تبدأ بـ "مرحباً 👋" وتتضمن:
  • بيانات شخصية كاملة للشخص (الاسم، الهاتف، رقم الهوية)
  • تفاصيل السيارة (رقم اللوحة، الماركة، الموديل)
  • نوع العملية (تسليم أو استلام) مع تاريخ العملية
  • روابط مباشرة لتحميل PDF العام للتسليم والاستلام
