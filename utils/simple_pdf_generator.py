...
def create_vehicle_handover_pdf(handover_data):
    ...
    try:
        ...
        text_width = c.stringWidth("Vehicle Handover Document", "Helvetica-Bold", 16)
        c.drawString((width - text_width)/2, height-50, "Vehicle Handover Document")
        ...
        text1 = "Generated by Vehicle Management System"
        text1_width = c.stringWidth(text1, "Helvetica-Oblique", 8)
        c.drawString((width - text1_width)/2, y_position, text1)
        
        text2 = "For verification, access the electronic form using the ID above"
        text2_width = c.stringWidth(text2, "Helvetica-Oblique", 8)
        c.drawString((width - text2_width)/2, y_position-12, text2)
