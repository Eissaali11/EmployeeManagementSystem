...
def arabic_text(text):
    ...
    arabic_to_latin = {
        ...
        'تقرير سجلات الورشة للسيارة': 'Workshop Records Report for Vehicle',
        'السيارة': 'Vehicle', 'سجلات الورشة': 'Workshop Records',
        'لا توجد سجلات ورشة لهذه السيارة': 'No workshop records for this vehicle',
        'إجمالي تكاليف الصيانة': 'Total Maintenance Cost', 'ريال': 'SAR',
        'إجمالي عدد أيام الورشة': 'Total Days in Workshop', 'يوم': 'Day(s)',
        'تم إنشاء هذا التقرير بواسطة نُظم في': 'This report was generated by NUZOM on',
        'نُظم - جميع الحقوق محفوظة': 'NUZOM - All Rights Reserved'
    }
